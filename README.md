# Simple project featuring backend approach with Java + Spring Boot + JPA


### Description

Project includes sample logic for 2 Entities (Job, Candidate). Candidate can be assigned to many jobs. Job may have many candidates.

Current configuration contains in memory database, with possibility to switch to PostgreSQL.

Services includes best practised related to `@Transactional` and ORM approach in JPA.
